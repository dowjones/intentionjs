/*!
 * context.js + intention.js @ v0.9.6.2
...
this)},this))},_contextualize:function(b,a,c){c[b].current=a;return c},_axis_test_pattern:/^_[^_]/,_axis_match_pattern:/^_([a-zA-Z0-9][_a-zA-Z0-9]*)/};return h});(function(){var f=function(d,h){var f=new h,b,a;f.responsive([{name:"base"}]).respond("base");b=f.responsive({ID:"width",contexts:[{name:"standard",min:840},{name:"tablet",min:510},{name:"mobile",min:0}],matcher:function(c,a){return"string"===typeof c?c===a.name:c>=a.min},measure:function(a){return"string"===typeof a?a:d(window).width()}});a=f.responsive({ID:"orientation",contexts:[{name:"portrait",rotation:0},{name:"landscape",rotation:90}],matcher:function(a,b){return a===b.rotation},measure:function(){var a=
