...
function(e,g){if("move"===g){if(a.__placement__!==e.placement||a.__move__!==e.value)f(e.value)[e.placement](b),a.__placement__=e.placement,a.__move__=e.value}else if("class"===g){var h=b.attr("class")||"",h=d.union(e,d.difference(h.split(" "),this._removeClasses(a,c)));b.attr("class",h.join(" "))}else b.attr(g,e)},this)}return b},_respond:function(b,a){a.each(d.bind(function(c,a){var d=f(a.elm);this._makeChanges(d,a.spec,b);d.trigger("intent",this)},this))},_contextualize:function(b,a,c){c[b].current=
a;return c},_axis_test_pattern:/^_[^_]/,_axis_match_pattern:/^_([a-zA-Z0-9][_a-zA-Z0-9]*)/};return h});(function(){var f=function(d,h){var f=new h,b,a;f.responsive([{name:"base"}]).respond("base");b=f.responsive({ID:"width",contexts:[{name:"standard",min:840},{name:"tablet",min:510},{name:"mobile",min:0}],matcher:function(c,a){return"string"===typeof c?c===a.name:c>=a.min},measure:function(a){return"string"===typeof a?a:d(window).width()}});a=f.responsive({ID:"orientation",contexts:[{name:"portrait",rotation:0},{name:"landscape",rotation:90}],matcher:function(a,b){return a===b.rotation},measure:function(){var a=
