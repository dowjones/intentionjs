define('Intention', ['jquery'], function ($) {
    ...
    var Intention = function(params){
      ...
      if(this.container){
        // if intention is bound to a container
        this._setResponsiveElms(this.container);  
      } else {
        //otherwise it is all about the window
    ...
    Intention.prototype = {
      ...
      addFrom: function(context){
        ...
        if(context){
          ...
          $(context).find('[data-intention]').each(
            this.hitch(this, function(i, elm){
              this.elms.push(elm);
          }));
          return;
        } 
      ...
      _setResponsiveElms: function(context){
        ...
        if(context){
          // in the elms array before adding it
          this.elms = $(context).find('[data-intention]');
...
// if ( typeof define === "function" && define.amd && define.amd.Intention ) {
//   define( "Intention", ['jquery'], function ($) { return Intention; } );
// }