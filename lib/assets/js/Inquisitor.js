define('Inquisitor', function (inq) {

  (function(){    

    window.Inquisitor = function(params){
      ...
      window.Inquisitor.prototype = {
        ...
        _bindEvents: function(){
          ...
          if(document.addEventListener){
            ...
            window.addEventListener('resize', 
              this._throttle(this._hitch(this, this.inquire), 100), false);
          ...
          // IE
            ...
            if("onorientationchange" in window){
              document.attachEvent("orientationchange", 
                this.inquire);
            }

            document.attachEvent('resize', 
              this._throttle(this._hitch(this, this.inquire), 100));

          }

        },

        inquire: function(trigger){
        ...
        _getContext: function(){
          ...
          for(var i=0; i<this.thresholds.length; i++){
            if(window.innerWidth <= this.thresholds[i]){
              return i;
              break;
            }
          }
      ...
      var inq = new window.Inquisitor;

      if(!window.inquisitor){
        window.inquisitor = inq;
      } else {
        throw('YO! it looks like you have something else named "inq" in your global namespace!');
      }
