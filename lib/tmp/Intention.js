  ...
  module.exports = {
      Intention: function(params){
        ...
        var intentHandler = function(info){
          ...
          // console.log('the Context has changed here is the info: ', info);
  ...
  module.exports.Intention.prototype = {
    ...
    intent: function(context, html){
      ...
      this.filters = this._makeFilterPatterns(context);
      ...
      if(html){
        ...
        var elms = this.temp.find('[data-intention]');
    ...
    _move: function(elm, instruction) {
      ...
      if(placementSpec){
        this.temp.find(moveSelector)[placementSpec[1]]( elm );
      } else {
        this.temp.find(moveSelector).append( elm );
      }
